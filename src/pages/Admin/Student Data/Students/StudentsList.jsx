...
import { getStudents, createStudent, updateStudent, deleteStudent, exportStudents, importStudents } from '../../../../services/Admin/studentsService';
import { useAppContext } from '../../../../context/AppContext';
import Card from '../../../../components/UI/Card';
import Button from '../../../../components/UI/Button';
import Modal from '../../../../components/UI/Modal';
import { BookOpen, Search, Edit, Trash2, Eye, Plus, ArrowLeft, Menu, Users } from 'lucide-react';
...
const StudentsList = () => {
    ...
    if (students && students.length > 0) {
      const filtered = students.filter(student => {
        ...
        return nisn.toString().toLowerCase().includes(searchTerm.toLowerCase()) ||
               ...
               className.toString().toLowerCase().includes(searchTerm.toLowerCase());
      });
      setEntries(filtered);
    }
  }, [searchTerm, students]);
  ...
  const handleSubmitStudent = async (studentData) => {
    try {
      ...
      // Reset the page to first page to make sure user can see the new/updated student
      setCurrentPage(1);
      
      setError(null);
    } catch (err) {
      const errorMessage = studentData.id ? 'Failed to update student' : 'Failed to create student';
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{studentDetail?.class?.class_name || 'Not assigned'}</p>
                      </div>
                  ...
                  <tr key={student?.id || index} className="hover:bg-gray-50">
                    ...
                    <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex justify-end space-x-1 sm:space-x-2">
                        ...
                        <button
                          onClick={() => student?.id ? handleDeleteStudent(student.id) : null}
