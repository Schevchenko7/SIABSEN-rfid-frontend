...
import { User, Calendar, Clock, Tag, Eye, Edit, Trash2 } from 'lucide-react';

const AttendancesItem = ({ attendance, index, onView, onEdit, onDelete }) => {
      ...
      <div className="p-4">
        ...
        <div className="flex justify-end space-x-2 mt-3 pt-3 border-t">
          ...
          <button
            ...
            className="text-blue-500 hover:text-blue-700 p-1 rounded hover:bg-blue-50 flex items-center"
          ...
          <button
            ...
            className="text-red-500 hover:text-red-700 p-1 rounded hover:bg-red-50 flex items-center"
