...
import { ChevronDown, Search, Edit, Eye, Calendar, Menu } from 'lucide-react';
    ...
    <div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-3 md:p-4 flex flex-col md:flex-row justify-between items-start md:items-center border-b space-y-2 md:space-y-0">
          ...
          {/* Desktop: Search and Export always visible */}
          ...
          <div className="w-full md:hidden">
            ...
            {/* Collapsible export and view options */}
            {mobileMenuOpen && (
        ...
        <div className="p-3 md:p-4 bg-gray-50 border-b">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <div>
              <label htmlFor="studentFilter" className="block text-sm font-medium text-gray-700">Student</label>
              <input
                type="text"
                id="studentFilter"
                name="studentFilter"
            ...
            <div className="flex items-end">
              <Button onClick={resetFilters} variant="secondary" className="w-full text-sm md:text-base">
                Reset Filters
              </Button>
            </div>
          </div>
